...
industry_numeric_ids = dict(
    ...
    tyre_plant=47,
    paper_mill=48,
    basic_oxygen_furnace=49,
    coke_oven=50,
    slag_grinding_plant=51,
    engine_plant=52,
    biorefinery = 53,
    machine_works = 54,
    component_factory=55,
    integrated_steel_mill=56,
    wire_and_section_mill=57,
    body_plant=58,
    lime_kiln=59,
    factory_1 = 60,
    factory_2 = 61,
    factory_3 = 62,
    sheet_and_pipe_mill=63,
    civil_explosives_facility = 64,
    sugar_refinery = 65
)
...
metadata = {
    ...
    "repo_url": "https://github.com/matematysek/czis",
