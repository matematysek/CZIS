...
NML_FILE = C:\Users\matej\Documents\Zabava\NewGRF_vyroba\CZIS-master\CZIS-master\src\generated\czis.nml
...
$(NML_FILE):$(shell $(FIND_FILES) --ext=.py --ext=.pynml src)
	$(PYTHON3) src\render_nml.py $(-output czis.nml)	
