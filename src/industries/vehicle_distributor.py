...
industry.add_industry_layout(
    ...
    layout=[
        (0, 0, "vehicle_distributor_tile_1", "vehicle_distributor_spritelayout_1"),
        (0, 1, "vehicle_distributor_tile_1", "vehicle_distributor_spritelayout_2"),
        (0, 2, "vehicle_distributor_tile_1", "vehicle_distributor_spritelayout_2"),
        (1, 0, "vehicle_distributor_tile_1", "vehicle_distributor_spritelayout_2"),
        (1, 1, "vehicle_distributor_tile_1", "vehicle_distributor_spritelayout_2"),
        (1, 2, "vehicle_distributor_tile_1", "vehicle_distributor_spritelayout_2"),
    ],
)
